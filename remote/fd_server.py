...
# From an example with only very minor changes:
...
if __name__ == '__main__':
    ...
    parser = optparse.OptionParser(
        ...
        description = "Brother Knit Disk remote access server",
        epilog = """\
...
""")
    ...
    logging.info("Brother remote disk server - type Ctrl-C / BREAK to quit")
