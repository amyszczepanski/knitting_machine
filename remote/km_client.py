...
# Based on pyserial example code:
...
if __name__ == '__main__':
    ...
    parser = optparse.OptionParser(
        ...
        description = "Knitting machine to remote drive client",
        epilog = "")
    ...
    parser.add_option("-u", "--url",
        ...
        default = "nondim.dyndns.com:8086"
    )
    ...
    logging.info("Knitting machine remote disk client - type Ctrl-C / BREAK to quit")
    ...
    srv.connect((options.url, options.remoteport))
